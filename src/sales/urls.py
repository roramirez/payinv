...
urlpatterns = [
    ...
    url(r'^pending/invoice/$', views.SaleListPendingInvoice.as_view(), name='sale_list_pending_invoice'),
    url(r'^pending/payment/$', views.SaleListPendingPayment.as_view(), name='sale_list_pending_payment'),
